...
def add_screenshot(scenario)
    ...
    embed(screenshot,'image/png','ZA PRINTO')
end
...
def add_browser_logs
    ...
    #Reunir informações do navegador
    logs = page.driver.browser.manage.logs.get(:browser).map {|line| [line.level, line.message]}
    #remover warnings e mensagens de erro
    logs.reject! { |line| ['WARNING','ERROR'].include?(line.first)}
    logs.any? == true
